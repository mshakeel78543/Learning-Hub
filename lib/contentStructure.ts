...
export const contentStructure: Section[] = [
  {
    ...
    categories: [
      {
        id: 'api-recognition',
        title: 'API Recognition',
        icon: '🔍',
        topics: [
          { id: 'what-is-api', title: 'What is API?', file: 'Bunyadi Maloomat/API Ki Pehchan/API-Kya-Hai.html' },
      ...
      },
      {
        ...
        topics: [
          ...
          { id: 'headers', title: 'Importance of Headers', file: 'Bunyadi Maloomat/HTTP Protocol/Headers-Ki-Ahmiyat.html' },
    ...
    categories: [
      {
        ...
        icon: '🔎',
        topics: [
          { id: 'api-documentation', title: 'Reading API Documentation', file: 'Shurwati Hamle/Maloomat Jama Karna/API-Documentation-Padhna.html' },
          { id: 'google-dorking', title: 'Google Dorking', file: 'Shurwati Hamle/Maloomat Jama Karna/Google-Dorking.html' },
          { id: 'shodan', title: 'Using Shodan', file: 'Shurwati Hamle/Maloomat Jama Karna/Shodan-Istemal.html' },
          { id: 'wayback-machine', title: 'Using Wayback Machine', file: 'Shurwati Hamle/Maloomat Jama Karna/Wayback-Machine-Istemal.html' },
          ...
          { id: 'burp-suite', title: 'Using Burp Suite', file: 'Shurwati Hamle/Maloomat Jama Karna/Burp-Suite-Ka-Istemal.html' },
        ]
      },
      {
        id: 'auth-bypass',
    ...
    categories: [
      {
        ...
        topics: [
          ...
          { id: 'missing-func-level', title: 'Missing Function Level Access Control', file: 'Hamlon Ki Iqsam/Broken Access Control/Missing-Function-Level-Access.html' },
